...
<!-- Mirrored from uselooper.com/auth-signin-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Mar 2025 17:51:07 GMT -->
...
<body>
    ...
    <main class="auth">
        <header id="auth-header" class="auth-header"
            style="background-image: url({{asset('admin/assets/images/illustration/img-1.png')}});">
            <h1>
            ...
            <p> Don't have a account? <a href="{{ route('user.register') }}">Create One</a>
            </p>
        </header><!-- form -->
        <form action="{{ route('user.login.submit') }}" method="POST" class="auth-form">
            @csrf
            <!-- .form-group -->
            <div class="form-group">
                <div class="form-label-group">
                    <input type="email" id="inputUser" name="email" class="form-control" placeholder="Username" autofocus=""> <label
            ...
            <div class="form-group">
                <div class="form-label-group">
                    <input type="password" name="password" id="inputPassword" class="form-control" placeholder="Password"> <label
...
<!-- Mirrored from uselooper.com/auth-signin-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Mar 2025 17:51:08 GMT -->
